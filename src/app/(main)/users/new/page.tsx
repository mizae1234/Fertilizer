    ...
    return (
        <div className="animate-fade-in max-w-2xl mx-auto">
            ...
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h1 className="text-xl sm:text-2xl font-bold text-gray-800">➕ เพิ่มผู้ใช้ใหม่</h1>
                    <p className="text-sm text-gray-500 mt-1">สร้างบัญชีผู้ใช้และกำหนดสิทธิ์เมนู</p>
                </div>
            </div>
