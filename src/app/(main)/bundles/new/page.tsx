...
export default function NewBundlePage() {
    ...
    return (
        <div className="max-w-2xl mx-auto animate-fade-in">
            <h1 className="text-2xl font-bold text-gray-800 mb-6">🎁 สร้างชุดสินค้าใหม่</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6 space-y-4">
                    ...
                    <div>
                        <div>
                            ...
                            <input
                                ...
                                placeholder="เช่น ชุดปุ๋ยสวนยาง"
                                required
                            />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:ring-2 focus:ring-emerald-500 focus:border-transparent outline-none text-sm"
                            rows={2}
                            placeholder="รายละเอียดชุดสินค้า..."
                        />
                    </div>
                ...
                <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6 space-y-4">
                    ...
                    {/* Selected Items */}
                    {items.length === 0 ? (
                        <p className="text-sm text-gray-400 text-center py-6">ยังไม่ได้เลือกสินค้า — ค้นหาสินค้าด้านบนเพื่อเพิ่มในชุด</p>
                    ) : (
                ...
                <div className="flex gap-3">
                    ...
                    >
                        {loading ? 'กำลังบันทึก...' : 'บันทึกชุดสินค้า'}
                    </button>
                </div>
            </form>
            <AlertModal open={alertModal.open} onClose={() => setAlertModal({ ...alertModal, open: false })} message={alertModal.message} type={alertModal.type} title={alertModal.type === 'error' ? 'เกิดข้อผิดพลาด' : 'สำเร็จ'} />
        </div>
    );
}
